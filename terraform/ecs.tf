  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "SALES_LEAD_RECIPIENT_EMAIL"
          value = var.sales_lead_recipient_email
        },
        {
          name  = "SALES_LEAD_FROM_EMAIL"
          value = var.sales_lead_from_email
        },
        {
          name  = "SALES_LEAD_FROM_NAME"
          value = var.sales_lead_from_name
        }
      ]
...
resource "aws_ecs_service" "app" {
  ...
  network_configuration {
    ...
    assign_public_ip = true # Assign public IP for internet access (no NAT needed)
  }
